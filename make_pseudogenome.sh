...
# usage: make_pseudogenome.sh syri.out ref_name alt_name ref_genome output_directory scripts_directory 
...
scripts="$6" # must include helper script syri_snps2bed.py
